...
6. Para alterações de UI, exigir evidência visual **pontual e real** quando necessária ao gate; não produzir capturas repetitivas nem simular aprovação. Respeitar `docs/DESIGN_SYSTEM.md` v2 e `docs/design-system/LUNA_HANDOFF.md`. Abrir as âncoras AP-01 a AP-05 pertinentes antes de editar UI. Código legado e presets não prevalecem sobre referências aprovadas.
